AutoForm.addInputType("bootstrap-datetimepicker", {
  ...
  valueOut: function () {
    var m = this.parent().data("DateTimePicker").date();
...
Template.afBootstrapDateTimePicker.rendered = function () {
  var $inputGroup = this.$('.input-group.date');
  var data = this.data;
  ...
  $inputGroup.datetimepicker(opts);

  // set and reactively update values
  this.autorun(function () {
    var data = Template.currentData();
    var dtp = $inputGroup.data("DateTimePicker");
    // set field value
    // console.log(data);
...
Template.afBootstrapDateTimePicker.destroyed = function () {
  var dtp = this.$('.input-group.date').data("DateTimePicker");
  if (dtp) {
    dtp.destroy();
  }
};
