goodieal:autoform-bs-datetimepicker
=========================

Fork from [aldeed:autoform-bs-datetimepicker](https://github.com/aldeed/meteor-autoform-bs-datetimepicker.git)

Modified to support autoform 6+ and autoform-bs-datetimepicker 4.17.37_1
...
```bash
$ meteor add goodideal:autoform-bs-datetimepicker
```
